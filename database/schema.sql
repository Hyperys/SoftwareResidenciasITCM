...
CREATE TABLE residentes (
    ...
    FOREIGN KEY (revisor_id) REFERENCES revisores (id) ON DELETE SET NULL ON UPDATE CASCADE,
...
VALUES (
        'ruta_archivos',
        'C:/Residencias/',
        'Ruta base para almacenamiento de expedientes'
    ),
    (
        'ruta_backup_default',
        'C:/Residencias/Backups/',
        'Ruta por defecto para backups manuales'
    );

-- Tipos de Documento
INSERT INTO
    tipos_documento (clave, descripcion)
VALUES (
        'solicitud_residencia',
    ...
    (
        'reporte_final_firmas',
        'Práctica del reporte final con firmas'
    ),
    (
        'carta_liberacion',
...
INSERT INTO
    especialidades (carrera_id, nombre)
...
VALUES (
        ...
        'interno',
        'Industrial',
        'maria.gonzalez@madero.tecnm.mx',
        '8334445566',
        'Jefa de Docencia'
    );
...
-- Revisor Externo (ligado a empresa 1 - PEMEX)
INSERT INTO
    revisores (
        empresa_id,
        nombres,
...
VALUES (
        ...
        'anatorres@email.com',
        '8335551122',
        'Sistema de Gestión de Almacenes Web',
        'Desarrollo',
        '08:00 - 14:00',
        'ENE-JUN',
        2024,
...
VALUES (
        '21040001',
        1,
        'Solicitud_Residencia_21040001.pdf',
        '2024/21040001/solicitud.pdf',
        150
    ),
    (
        '21040001',
        4,
        'Anteproyecto_21040001.pdf',
        '2024/21040001/anteproyecto.pdf',
        2048
    ),
    (
        '21040001',
        6,
        'Asignacion_Asesor_21040001.pdf',
        '2024/21040001/asignacion.pdf',
        300
    );
...
VALUES (
        'C:/Residencias/Backups/backup_20240213_1200.sql',
        'manual',
        5.24,
        TRUE,
        'Backup inicial antes de carga masiva'
    );
...
SET
    valor = 'C:\\Users\\Max\\.vscode\\SoftwareResidencias\\expedientespdf'
WHERE
    clave = 'ruta_archivos';

UPDATE configuracion
SET
    valor = 'C:\\Users\\Max\\.vscode\\SoftwareResidencias\\backup'
WHERE
    clave = 'ruta_backup_default';
